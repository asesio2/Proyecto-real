        ...
        <div class="full">
            <div class="menu">
                <ul>
                    ...
                    <li><a href="insUsuariosRegistro.blade.php"><div class="bk"><i class="booking" style="color: white">Registrar</i><i class="booking1">Registrar</i></div></a></li>
            ...
            <div class="main">
                <div class="contact-content">
                    ...
                    <form>
                        <div>
                            <h1>Listar y Eliminar Usuarios</h1>
                        </div>
