        ...
        <div class="full">
            <div class="menu">
                <ul>
                    ...
                    <li><a href="insAlumnoListar.blade.php"><div class="bk"><i class="booking" style="color: white">Listar</i><i class="booking1">Listar</i></div></a></li>
            ...
            <div class="main">
                <div class="contact-content">
                    ...
                    <div class="main-contact">
                        <h3 class="head">Registro de Alumno Nuevos</h3>
                        ...
                        <div class="contact-form">
                            <form>
                                <div class="col-md-6 contact-left">
                                    ...
                                    <input type="text" placeholder="Telefonos" required/>
