            ...
            <div class="main">
                <div class="contact-content">
                    ...
                    <div class="main-contact">
                        <h3 class="head">Registro de Profesores Nuevos</h3>
                        ...
                        <div class="contact-form">
                            <form>
                                <div class="col-md-6 contact-left">
                                    ...
                                    <input type="text" placeholder="Fecha de Contratacion" required/>
                                    <input type="text" placeholder="Asignatura" required/>
                                    <input type="text" placeholder="Valor Tutoria" required/>                                        
